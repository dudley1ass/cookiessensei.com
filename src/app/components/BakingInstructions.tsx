...
const BAKING_DATA: Record<string, BakingData> = {
  ...
  'macaron-meringue': {
    ...
    prepSteps: [
      'Two paths: French macaron shells (almond flour + powdered sugar in the base) vs crisp meringue kisses (no almond flour — see low-temp drying steps below)',
      ...
      'For French macarons: sift almond flour and powdered sugar together twice; macaronage until batter flows like lava',
      'For French macarons: rest piped shells until a skin forms (30–60 min) before baking',
      'For French macarons: age egg whites in the fridge uncovered 24 hours optionally to reduce moisture',
      'For plain meringue cookies: fresh room-temp whites work perfectly',
      'For meringue-only batches: preheat oven to 200–225°F (93–107°C) — low heat dries the foam without browning',
      'Line sheets with parchment paper — meringues will stick to greased pans or foil',
      'Prepare piping bag with a star or round tip for uniform portions',
    ],
    bakingSteps: [
      'FOR FRENCH MACARON SHELLS (recipe includes almond flour): bake ~300°F (150°C) 12–18 min until feet form and tops are set — not the low-temp drying method below',
      'FOR CRISP MERINGUE COOKIES (no almond flour): beat egg whites with cream of tartar and salt on medium speed until foamy',
      ...
      'Meringue path only: bake at 200–225°F for 75–100 minutes until completely dry and crisp throughout',
      'Meringue path only: turn oven off and leave pieces inside with door closed for 1 more hour',
      'Meringue path only: this slow rest finishes drying centers — do not skip it',
      'Cool completely on the pan before handling',
    ],
    doneness:
      'French macaron shells: smooth tops, defined feet, centers softly set — not as dry as meringue kisses. Crisp meringue cookies: fully dry throughout, lift cleanly from parchment; interior hollow or lightly chewy, exterior matte.',
    tips: [
    ...
    commonMistakes: [
      ...
      'Using the low meringue temperature for French macaron shells — they need ~300°F and rested skin first',
      'Baking meringue kisses too hot — they brown instead of drying; keep oven low (200–225°F)',
      'Opening oven during low meringue bake — temperature drop causes cracking',
      'Skipping the meringue oven-rest — centers stay chewy and sticky without it',
      'Storing meringues without airtight container — absorb humidity and turn soft within hours',
    ],
  },
  'sandwich-cookie': {
  ...
  'fried-cookie': {
    ...
    prepSteps: [
      ...
      'Work in small batches — overcrowding drops oil temperature and makes greasy fried dough',
    ],
    bakingSteps: [
    ...
    tips: [
      ...
      'A spider skimmer (flat wire basket on a handle) is the best tool for removing pieces from the oil',
    ],
    storage: 'Best eaten immediately — fried pastries lose crispness within hours. If needed, store uncovered at room temp up to 1 day. Re-crisp in a 350°F oven for 5 minutes. Do not refrigerate — steam makes them soggy.',
    commonMistakes: [
      'Oil too cold — dough absorbs oil and turns out greasy and pale',
