...
import { CookieScienceLinks } from './components/CookieScienceLinks';
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Cookie Science Links */}
            <CookieScienceLinks activeArticleUrl={selectedCookieType.articleUrl} />
